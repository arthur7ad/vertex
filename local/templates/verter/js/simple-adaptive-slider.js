...
class ItcSimpleSlider1 {
	// базовые классы и селекторы
	static PREFIX = 'itcss1';
	static EL_WRAPPER = `${ItcSimpleSlider1.PREFIX}__wrapper`;
	static EL_ITEM = `${ItcSimpleSlider1.PREFIX}__item`;
	static EL_ITEM_ACTIVE = `${ItcSimpleSlider1.PREFIX}__item_active`;
	static EL_ITEMS = `${ItcSimpleSlider1.PREFIX}__items`;
	static EL_INDICATOR = `${ItcSimpleSlider1.PREFIX}__indicator`;
	static EL_INDICATOR_ACTIVE = `${ItcSimpleSlider1.PREFIX}__indicator_active`;
	static EL_INDICATORS = `${ItcSimpleSlider1.PREFIX}__indicators`;
	static EL_CONTROL = `${ItcSimpleSlider1.PREFIX}__btn`;
