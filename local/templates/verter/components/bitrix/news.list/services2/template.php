...
<?foreach($arResult["ITEMS"] as $k => $arItem):?>
    <?if($k == 0){?>
        <li>
            <figure class="light">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/sales/1.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
    ...
    <?}elseif($k == 1){?>
        <li>
            <figure class="light">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/sales/2.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
    ...
    <?}elseif($k == 2){?>
        <li>
            <figure class="dark">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/sales/3.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
    ...
    <?}elseif($k == 3){?>
        <li>
            <figure class="dark">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/sales/4.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
