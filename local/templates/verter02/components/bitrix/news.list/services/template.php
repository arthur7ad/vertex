...
<?foreach($arResult["ITEMS"] as $k => $arItem):?>
    <?if($k == 0){?>
        <li>
            <figure class="light">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img1.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
        ...
        <!-- <div class="flex flex-col my-4 sm:my-[50px] h-fit sm:h-72 rounded-lg sm:rounded-2xl justify-between p-6 sm:p-8 bg-white
            ...
            <div class="block z-10">
                <p class="text-[26px] sm:text-5xl font-bold text-main-blue mb-4"><?=$arItem['NAME']?></p>
            ...
            <p class="text-sm sm:text-lg underline underline-offset-4 font-semibold z-10 mt-4 sm:mt-0">
                <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="cursor-pointer">Подробнее</a>
            </p>
    ...
    <?}elseif($k == 1){?>
        <li>
            <figure class="dark">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img2.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
        ...
        <!-- <div class="flex flex-col gap-4 sm:gap-[50px] xl:flex-row my-0 sm:mt-[50px] text-white">
            <div
                ...
                <p class="text-sm sm:text-lg underline underline-offset-4 font-semibold z-10 mt-4 sm:mt-0"><a
                            href="<?=$arItem['DETAIL_PAGE_URL']?>" class="cursor-pointer">Подробнее</a>
                </p>
    ...
    <?}elseif($k == 2){?>
            <li>
                <figure class="light">
                    <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img3.png" alt="<?=$arItem['NAME']?>" class="img">
                    <figcaption>
                        <div class="text">
                            <h2><?=$arItem['NAME']?></h2>
                            <p><?=$arItem['PREVIEW_TEXT']?></p>
            ...
            <!-- <div
                ...
                <div class="block z-10">
                    <p class="text-[26px] sm:text-5xl font-bold mb-4 text-main-blue"><a></a><?=$arItem['NAME']?></p>
                    <p class="text-sm sm:text-xl w-1/2 sm:w-[480px]"><?=$arItem['PREVIEW_TEXT']?></p>
                </div>
                <p class="text-sm sm:text-lg underline underline-offset-4 font-semibold z-10 mt-4 sm:mt-0"><a
                            href="<?=$arItem['DETAIL_PAGE_URL']?>" class="cursor-pointer">Подробнее</a>
    ...
    <?}elseif($k == 3){?>
        <li>
            <figure class="dark">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img4.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
        ...
        <!-- <div class="flex flex-col mt-4 sm:mt-[50px] overflow-hidden h-fit rounded-lg sm:rounded-2xl justify-between p-6 sm:p-8 bg-main-blue text-white shadow-main w-full relative ">
            ...
            <p class="text-sm sm:text-lg underline underline-offset-4 font-semibold z-10 mt-4 sm:mt-0"><a href="<?=$arItem['DETAIL_PAGE_URL']?>"
    ...
    <?}elseif($k == 4){?>
        <li>
            <figure class="light">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img5.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
        ...
        <!-- <div class="flex flex-col gap-4 sm:gap-[50px] xl:flex-row mt-4 sm:mt-[50px] text-black ">
            <div
                ...
                <div class="block z-10 w-[350px]">
                    <p class="text-[26px] sm:text-5xl font-bold mb-4 text-main-blue"><?=$arItem['NAME']?></p>
                ...
                <p
                    ...
                    <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="cursor-pointer">Подробнее</a></p>
                <img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="monitoring"
    ...
    <?}elseif($k == 5){?>
        <li>
            <figure class="dark">
                <img src="<?=SITE_TEMPLATE_PATH?>/imgs/product/img6.png" alt="<?=$arItem['NAME']?>" class="img">
                <figcaption>
                    <div class="text">
                        <h2><?=$arItem['NAME']?></h2>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
